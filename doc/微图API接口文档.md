...
|  请求参数  | 必须 | 参数类型 | 参数说明       | 备注                           |
| :--------: | :--: | :------: | :------------- | ------------------------------ |
|   wd_way   |  否  |  String  | 支付宝提现方式 | 支付宝提现需要传，默认为支付宝 |
|  bank_id   |  否  |  String  | 银行id         | 银行卡提现需要传               |
